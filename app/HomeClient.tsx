                ...
                <div className="mx-auto w-full max-w-6xl px-4 pb-20 space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    ...
                    {isLoading ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[...Array(8)].map((_, i) => (
                                <div key={i} className="bg-white rounded-3xl border border-emerald-50 p-6 animate-pulse h-[340px]" />
                            ))}
                        </div>
                    ) : (
                        <>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                    {creators.map((creator, index) => (
                                        <Link
                                            ...
                                            className="group bg-white rounded-3xl border border-emerald-50 p-6 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center"
                                        >
                                            <div className="relative mb-4">
                                                ...
                                                <div className="absolute -bottom-1 -right-1 bg-white p-1.5 rounded-full">
                                            ...
                                            <div className="w-full pt-4 border-t border-slate-50 flex items-center justify-between">
                                                ...
                                                <div
                                                    ...
                                                    className={`group/heart h-10 w-10 flex items-center justify-center rounded-2xl transition-all cursor-pointer ${creator.is_favorited ? "bg-emerald-600 text-white" : "bg-emerald-50 text-emerald-600 hover:bg-emerald-600 hover:text-white"}`}
                                                >
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-10 px-2">
                                    ...
                                    <div className="flex items-center gap-2 order-1 sm:order-2">
                                        <button
                                            ...
                                            className="h-11 px-4 flex items-center gap-2 rounded-2xl bg-white border border-slate-200 text-slate-600 font-semibold text-sm hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-200 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                                        >
